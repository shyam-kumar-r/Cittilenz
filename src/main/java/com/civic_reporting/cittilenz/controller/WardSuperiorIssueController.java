...
public class WardSuperiorIssueController {
    ...
    public ResponseEntity<ApiResponse<WardSuperiorDashboardResponse>> getDashboard(
            Authentication authentication
    ) {
        ...
        WardSuperiorDashboardResponse response =
                dashboardAnalyticsService.getWardSuperiorDashboard(
                        superior.getWardId()
                );
